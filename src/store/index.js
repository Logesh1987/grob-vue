...
export default new Vuex.Store({
	...
	actions: {
		getSetupData: ({ commit, state }) => {
			commit('enableLoader');
			return Axios.get('https://jai.devam.pro/gr/admin/onboarding?id_shop=1325&admin_email=jayakumar@appsmav.com')
				.then((res) => {
		...
		saveSetupData: ({ commit }, payload) => {
			...
			return Axios.post(
				'https://jai.devam.pro/gr/admin/onboarding?id_shop=1325&admin_email=jayakumar@appsmav.com',
				payload,
				headersData
			)
				.then((res) => {
		...
		getRewardsData: ({ commit, state }) => {
			commit('enableLoader');
			return Axios.get('https://jai.devam.pro/gr/admin/rewards?id_shop=1325&admin_email=jayakumar@appsmav.com')
				.then((res) => {
		...
		addReward: ({ commit }, payload) => {
			...
			let result = Axios.post(
				'https://jai.devam.pro/gr/admin/rewards?id_shop=1325&admin_email=jayakumar@appsmav.com',
				payload,
				headersData
			)
				.then((res) => {
		...
		deleteReward: ({ commit, state }, id) => {
			commit('enableLoader');
			Axios.delete(
				'https://jai.devam.pro/gr/admin/rewards?id_shop=1325&admin_email=jayakumar@appsmav.com&id=' + id
			)
				.then((res) => {
		...
		getPopupData: ({ commit, state }) => {
			commit('enableLoader');
			return Axios.get('https://jai.devam.pro/gr/admin/themes?id_shop=1325&admin_email=jayakumar@appsmav.com')
				.then((res) => {
		...
		saveThemeSettings: ({ commit }, payload) => {
			commit('enableLoader');
			return Axios.put(
				'https://jai.devam.pro/gr/admin/themes?id_shop=1325&admin_email=jayakumar@appsmav.com',
				payload,
				headersData
			)
				.then((res) => {
		...
		getWidgetData: ({ commit, state }) => {
			commit('enableLoader');
			return Axios.get('https://jai.devam.pro/gr/admin/widgets?id_shop=1325&admin_email=jayakumar@appsmav.com')
				.then((res) => {
		...
		saveWidgetData: ({ commit }, payload) => {
			commit('enableLoader');
			return Axios.put(
				'https://jai.devam.pro/gr/admin/widgets?id_shop=1325&admin_email=jayakumar@appsmav.com',
				payload,
				headersData
			)
				.then((res) => {
		...
		updateLoyaltyStatus: ({ commit }, status) => {
			commit('enableLoader');
			return Axios.post(
				'https://jai.devam.pro/gr/admin/onboarding/updateLoyalty?id_shop=1325&admin_email=jayakumar@appsmav.com',
				{ status: status },
				headersData
			)
				.then((res) => {
		...
		submitReview: ({ commit }, review) => {
			return Axios.post(
				'https://jai.devam.pro/gr/admin/onboarding/review?id_shop=1325&admin_email=jayakumar@appsmav.com',
				review,
				headersData
			)
				.then((res) => {
