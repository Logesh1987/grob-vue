...
export default new Vuex.Store({
	...
	actions: {
		getSetupData: ({ commit, state }) => {
			...
			//alert("TEST");
			return Axios.get(
				'https://jai.devam.pro/gr/admin/onboarding?id_shop=1226&admin_email=jayakumar@appsmav.com'
			).then((res) => {
		...
		getRewardsData: ({ commit, state }) => {
			return Axios.get(
				'https://jai.devam.pro/gr/admin/rewards?id_shop=1226&admin_email=jayakumar@appsmav.com'
			).then((res) => {
		...
		deleteReward: ({ commit, state }, id) => {
			Axios.delete(
				'https://jai.devam.pro/gr/admin/rewards?id_shop=1226&admin_email=jayakumar@appsmav.com&id=' + id
			)
				.then((res) => {
		...
		getPopupData: ({ commit, state }) => {
			...
			return Axios.get(
				'https://jai.devam.pro/gr/admin/themes?id_shop=1226&admin_email=jayakumar@appsmav.com'
			).then((res) => {
		...
		getWidgetData: ({ commit, state }) => {
			return Axios.get(
				'https://jai.devam.pro/gr/admin/widgets?id_shop=1226&admin_email=jayakumar@appsmav.com'
			).then((res) => {
				//console.log("#####################################################");
				//console.log(JSON.stringify(res.data.data));
				//console.log("#####################################################");
